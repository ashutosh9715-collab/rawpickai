---
title: "White House Drafts AI Vetting Order, Pennsylvania Sues Character.AI Over Fake Doctors"
description: "White House plans FDA-style AI model vetting after Mythos. Pennsylvania files first governor-led lawsuit against Character.AI for fake doctors."
slug: "/news/white-house-ai-vetting-order-pennsylvania-character-ai-lawsuit-may-8-2026"
...
![AI News May 8, 2026](/images/news/news-may-8-2026-hero.svg)
...
**My take:** This changes the game for every tool I review. If pre-deployment vetting becomes reality, it creates a two-tier market: established labs with regulatory teams (OpenAI, Anthropic, Google) who can absorb compliance costs, and smaller players who cannot. For end users choosing between [ChatGPT](/review/chatgpt), [Claude](/review/claude), or [Gemini](/review/google-gemini), this likely means nothing changes in the short term since these companies are already participating voluntarily. But for open-source models like DeepSeek and Llama, the compliance burden could be significant. Watch for whether the order carves out exceptions for open-weight models or treats them identically to proprietary ones.
