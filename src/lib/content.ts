...
export function getRelatedContent(slug: string, category: string, contentType: "review" | "blog" | "comparison" | "best-of" | "learn"): RelatedItem[] {
  ...
  const currentHref = contentType === "review"
    ? `/review/${slug}`
    : contentType === "blog"
    ? `/blog/${slug}`
