...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: fm.title, description: fm.description || "", robots: NOINDEX_ROBOTS, alternates: { canonical: `https://rawpickai.com/best-of/${slug}` }, openGraph: { title: fm.title, description: fm.description || "", url: `https://rawpickai.com/best-of/${slug}`, type: "article", images: [{ url: ogUrl, width: 1200, height: 630 }] }, twitter: { card: "summary_large_image", images: [ogUrl] } };
}
