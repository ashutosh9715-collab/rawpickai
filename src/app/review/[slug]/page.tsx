...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    robots: isReviewIndexable(slug) ? { index: true, follow: true } : NOINDEX_ROBOTS,
...
export default async function ReviewPage({ params }: Props) {
  ...
  // Structured review data mirrors the visible editorial score without
  // manufacturing an aggregate rating from a single review.
  const reviewSchema = {
