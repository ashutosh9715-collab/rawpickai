...
export const metadata = {
  title: "AI Tool Comparisons — RawPickAI",
              ...
              <div className="card card-hover flex items-center gap-5 !py-5 !px-6">
                <div className="flex-1">
                  <div className="flex items-center gap-2.5 mb-1 flex-wrap">
                    <span className="heading text-base font-semibold">{fm.toolA || ""} vs {fm.toolB || ""}</span>
                ...
                {fm.winner && (
                  <div className="flex-shrink-0 text-right">
                    ...
                    <div className="text-sm font-semibold heading" style={{ color: "var(--sage-dark)" }}>{fm.winner}</div>
                  </div>
                )}
              </div>
            </Link>
