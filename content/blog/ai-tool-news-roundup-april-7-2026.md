---
title: "Sora Shut Down, Cursor 3 Rebuilt, Claude Code Hit $1B: AI Tool News (April 7, 2026)"
description: "This week in AI tools: OpenAI killed Sora, Cursor shipped a ground-up rebuild with parallel agents, Claude Code crossed $1B revenue, and Google dropped."
slug: "/blog/ai-tool-news-roundup-april-7-2026"
...
# Sora Shut Down, Cursor 3 Rebuilt, Claude Code Hit $1B: AI Tool News (April 7, 2026)

> **TL;DR:** This is the latest AI news for April 2026  -  Cursor 3 launched with parallel agents, Microsoft released 3 MAI models, Google dropped Gemma 4, and Sora shut down. If you're looking for AI coding tools updates April 2026 or developer tools news today, this roundup covers everything that matters.
...
**Why it matters:** Gemma 4 is the most capable open-source model for Indian developers. Its Hindi language support is the best in the open-source space, and the Apache 2.0 license means unrestricted commercial use. The E4B model running on a laptop is actually useful  -  not a toy.
...
The ₹1,860/month tier remains the standard for premium AI tools. The real story this week is the expansion of actually capable free options  -  Gemma 4 and Windsurf Free together give developers a powerful zero-cost toolkit that didn't exist three months ago.
...
### What is the latest AI news today (April 2026)?
The biggest AI news today is Cursor 3's launch with parallel agents (April 2), Microsoft releasing 3 MAI models (Transcribe, Voice, Image), Google open-sourcing Gemma 4, OpenAI shutting down Sora's standalone app, and Cursor releasing Composer 2  -  their proprietary coding model. See the launches above for full details.

### What are the biggest AI coding tools updates in April 2026?
Three major updates in coding tools this month: Cursor 3 launched with Agents Window and parallel execution (April 2), Composer 2 became Cursor's default model (March 19), and Claude Code captured 54% market share. Read our [best AI coding tools 2026](/blog/best-ai-coding-tools-2026) ranking for full analysis.

### What developer tools news matters today?
For developers specifically: Cursor 3's Design Mode is the biggest UX change in AI coding tools in years. Composer 2 makes Cursor 6x cheaper for routine coding. Claude Code now powers GitHub Copilot's coding agent. These three changes affect daily workflows for most developers.
...
*This is the first edition of our weekly AI Tool News Roundup. Published every Friday. Last updated: April 7, 2026. Pricing at ₹93/USD.*
