    ...
    <>
      ...
      <div className="max-w-[760px] mx-auto px-5 md:px-10 py-8 md:py-10 pb-16 md:pb-20 prose-counter-scope">
        <PageHero
          title={fm.title}
          description={fm.description || ""}
          breadcrumbs={[{ label: "Home", href: "/" }, { label: "Learn", href: "/learn" }, { label: fm.title.length > 40 ? fm.title.slice(0, 40) + "..." : fm.title }]}
        ...
        {(() => {
          const related = getRelatedContent(slug, fm.category || "", "learn");
        ...
        <RelatedPosts items={getRelatedContent(slug, fm.category || "", "learn").slice(1)} />
