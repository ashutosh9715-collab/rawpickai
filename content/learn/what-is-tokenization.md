...
**Be strategic with [RAG (Retrieval-Augmented Generation)](/learn/what-is-rag).**
...
Understanding tokenization helps you understand why [prompt engineering](/learn/what-is-prompt-engineering) matters at all.
...
If you are evaluating [AI agents](/learn/what-is-an-ai-agent) for production use, the agents that run many chained sub-tasks can burn tokens at 10-50x the rate of a single direct call.
...
[Large language models](/learn/what-is-an-llm) are fundamentally token predictors.

At their core, they learn to predict the next token given all previous tokens. The entire [transformer architecture](/learn/what-is-transformer-architecture) - attention heads, positional encodings, feed-forward layers - operates on sequences of token embeddings, not on raw text.
...
[Embeddings](/learn/what-are-embeddings) are representations of tokens (or sequences of tokens) as vectors in high-dimensional space.
...
[Fine-tuning](/learn/what-is-fine-tuning) a model does not change the tokenizer. This is an important constraint.
...
[RLHF (Reinforcement Learning from Human Feedback)](/learn/what-is-rlhf) also operates on token sequences.
...
[Hallucinations](/learn/what-is-ai-hallucination) sometimes have tokenization roots.
...
If you are just starting to explore how AI models work, reviewing our guides on [what RAG is](/learn/what-is-rag) and [what embeddings are](/learn/what-are-embeddings) will give you a complete picture of how text moves through an AI pipeline from input to output.
