---
title: "Google I/O 2026 Preview: Everything Expected Monday, Plus the Data Center Backlash Grows"
description: "Full Google I/O preview: Gemini 4.0, Omni video model, Android XR glasses, Aluminium OS. Meanwhile, anti-data-center resistance is spreading across the US."
slug: "/news/google-io-preview-75-percent-ai-code-data-center-resistance-may-16-2026"
lastUpdated: "2026-05-16"
author: "Ash"
category: "AI Industry"
---

# Google I/O 2026 Preview: Everything Expected Monday, Plus the Data Center Backlash Grows
...
![AI News May 16, 2026](/images/news/news-may-16-2026-preview-hero.svg)
...
**Confirmed by Google:**
- [Gemini](/review/google-gemini) model updates (new capabilities, likely a major version bump)
...
**My take:** If even half of the leaks are accurate, this will be the most significant Google I/O since the original Gemini launch. For tool comparison, the key question is whether Gemini Omni matches or exceeds [ChatGPT](/review/chatgpt) on text AND adds competitive image and video generation on top. If yes, the $20/mo AI Pro subscription (≈₹1,860/mo) becomes the best value in AI by a wide margin. I'll publish a full breakdown Monday evening with scores and pricing analysis. Follow the [news section](/news) for real-time coverage.
...
This resistance is why companies like [Google](/review/google-gemini) and SpaceX are exploring orbital data centers - not because space is cheaper (it isn't), but because there's nobody in orbit to object to the environmental impact.

**My take:** This story matters for AI tool pricing in a way most people don't realize. If communities successfully block enough data center construction, the compute supply tightens, and AI companies face a choice: raise prices or throttle capacity. The current $20/mo pricing for [Claude](/review/claude), [ChatGPT](/review/chatgpt), and [Gemini](/review/google-gemini) depends on continuous infrastructure expansion. If that expansion slows, the "unlimited AI for $20" era has an expiration date. This is the hidden risk nobody puts in their AI tool reviews. I do - because [it matters for the value-for-money calculation](/tools/compare).
...
**Google says 75% of new code is now AI-generated** and approved by engineers. Last fall it was 50%. A complex code migration was completed 6x faster with AI agents. If the company building [Gemini](/review/google-gemini) is writing three-quarters of its code with AI, the question for developers isn't whether to adopt [AI coding tools](/best-of/best-ai-code-assistants) - it's which one.
