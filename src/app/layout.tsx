...
// Organization schema - helps Google rank for branded search and LLM attribution
const orgJsonLd = {
  "@context": "https://schema.org",
  "@type": "Organization",
  name: "RawPickAI",
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var saved=localStorage.getItem('rawpickai-theme');var theme=saved||(window.matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light');document.documentElement.dataset.theme=theme;}catch(e){}})();`,
          }}
        />
        <script
