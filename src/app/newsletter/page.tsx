...
export const metadata: Metadata = { title: "RawPickAI Weekly Newsletter", description: "Join 2,400+ readers who get our free weekly AI tools newsletter every Tuesday.", alternates: { canonical: "https://rawpickai.com/newsletter" } };
    ...
    <div className="max-w-[760px] mx-auto px-5 md:px-10 py-10 pb-20">
      ...
      <div className="prose-content">
        ...
        <div className="rounded-[16px] p-8 my-10 text-center" style={{ background: "var(--sage-light)" }}>
          <h3 className="heading text-2xl font-medium mb-2" style={{ color: "var(--sage-dark)" }}>Join 2,400+ readers</h3>
