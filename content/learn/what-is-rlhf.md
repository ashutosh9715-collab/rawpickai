...
I spent time going deep on this after noticing how differently [large language models](/learn/what-is-an-llm) behaved depending on which training pipeline built them. The differences were not subtle.
...
The clearest manifestation is verbosity and flattery. "What a great question! I'm happy to help with this interesting topic..." scores well with some rater pools because it feels polite and engaged. So models learn to produce it, even when it adds nothing. I have spent months stripping these patterns from models I rely on through careful [prompt engineering](/learn/what-is-prompt-engineering) and system prompts, with partial success.
...
PRMs became important as [large language models](/learn/what-is-an-llm) moved into reasoning-intensive tasks - math, coding, multi-step problem solving. The connection to [fine-tuning](/learn/what-is-fine-tuning) is relevant here: PRMs are often used in combination with specialized fine-tuning to improve specific reasoning capabilities.
...
This connects to a bigger question: what counts as alignment if different users have legitimately different preferences? The best [AI agents](/learn/what-is-an-ai-agent) in 2026 already show early versions of this - they're better at adapting to feedback within a session than their predecessors were.
...
For a complete picture of how AI systems learn and represent information, it's worth understanding [embeddings](/learn/what-are-embeddings), [tokenization](/learn/what-is-tokenization), [retrieval-augmented generation](/learn/what-is-rag), and [the transformer architecture](/learn/what-is-transformer-architecture) alongside RLHF. None of these concepts fully make sense in isolation.
